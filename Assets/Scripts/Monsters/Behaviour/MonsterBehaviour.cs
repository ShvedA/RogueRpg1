...
namespace Assets.Scripts.Monsters.Behaviour {
    public class MonsterBehaviour : MonoBehaviour {
        ...
        private readonly Vector2[] directions = new Vector2[4] {
            ...
            if (spotted >= 0 && count >= 7) {
                ...
                if (count == 40) {
                    ...
                    if (wall == null) {
                        ...
                        randomMove =
                            Vector2.ClampMagnitude(new Vector2(positionWall.x - transform.position.x, positionWall.y - transform.position.y), 1f) * -1;
                    }
                }
                else if (count == 100) {
